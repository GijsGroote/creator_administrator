...
\scalebox{1.3}{%
  ...
  \begin{tikzpicture}[node distance = 3.0cm, line width=1pt]
    ...
    % arrows
    \draw[>=stealth, ->, line width=1.0pt] ([xshift=-1.0cm]wachtrij.west) to node[xshift=-0.5cm,left]{\textit{inbox} of \textit{selecteer bestand}} (wachtrij.west);
    ...
    \draw[>=stealth, ->, line width=1.0pt] (aan_het_printen.south) to node[left] {\textit{geprint}} (verwerkt.north);
