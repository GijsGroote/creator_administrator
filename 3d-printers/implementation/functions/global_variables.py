...
REPO_DIR_HOME = r'C:\Users\<user>\Documents\laserhok-workflow'
PRINT_DIR_HOME = r'C:\Users\<user>\Desktop\3d-print-test-env'
...
# email login info
global_path = os.path.abspath(r'C:\Users\<user>\.ssh\mail_credentials.json')
