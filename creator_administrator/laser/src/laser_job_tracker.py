...
class LaserJobTracker(JobTracker):
    ...
    def IsJobDictAndFileSystemInSync(self, job_dict, job_folder_global_path):
        ...
        tracker_laser_file_names = [os.path.basename(laser_file_dict['file_global_path']) for laser_file_dict in job_dict['make_files'].values()]
    ...
    def syncronizeJobDictWithFileSystem(self, job_dict: dict, job_folder_global_path: str):
        ...
        for file in valid_file_names:
            if not any([os.path.basename(laser_file_dict['file_global_path'])==file for laser_file_dict in job_dict['make_files'].values()]):
        ...
        if len(new_files_list) > 0:
            ...
            if yes_or_no.answer():
                ...
                file_info_dialog = CreateLaserJobsFromFileSystemQDialog(self.parent,
                                                [job_dict['job_name']],
                                                [new_files_list],
