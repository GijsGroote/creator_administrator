...
from src.qdialog import CreateJobsQDialog, CreateJobsQDialog
...
#         ui_global_path = os.path.join(gv['REPO_DIR_HOME'], 'printer/ui/import_mail_dialog.ui')
...
#             self.threadedSendReceivedMailAndCreatePrintJob()
#             self.msg_counter += 1
#             self.attachment_counter = 0
...
class PrintFileInfoQDialog(QDialog):
    ...
    def __init__(self, parent, job_name_list: list, files_global_paths_list: list, *args, **kwargs):
        ...
        loadUi(os.path.join(gv['REPO_DIR_HOME'], 'printer/ui/enter_job_details_dialog.ui'), self)
