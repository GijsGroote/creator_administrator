...
To walk through jobs use the arrow keys or the VIM key-bindings h, j, k and l. For up and down movement you can also use the Ctrl+n and Ctrl+p bindings.


:::tip tip

If you really want to be fast in handling job request, use the VIM keybindings.
